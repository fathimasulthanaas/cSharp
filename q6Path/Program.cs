...
string[] locations = new string[] { "tvpm", "palakkad", "ernakulam", "kannur", "ksgd" };
...
int z = 0;
var PeopleArray = new DistanceFair[lst.Count];
for (int i = 0; i < locations.Length; i++)
{
    for (int j = i + 1; j < locations.Length; j++)
    {
        ...
        PeopleArray[z] = new DistanceFair(locations[i], locations[j], num, short_path, fair, fair_short);
        z++;
    }
}
...
static void shorest_path(DistanceFair[] PeopleArray, string start, string end)
{
...
static void longest_path(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
        {
            Console.WriteLine("The longest path is : " + PeopleArray[i].long_path);
        }
    }
}
static void low_fair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
...
static void high_fair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
...
static void Short_Path_Lfair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
...
static void Short_path_Hfair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
...
static void longest_path_Hfair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
        {
            Console.WriteLine("The long path is : " + PeopleArray[i].short_path);
            Console.WriteLine("The shortest fair is : " + PeopleArray[i].fair_short);
        }
    }
}
static void longest_path_Lfair(DistanceFair[] PeopleArray, string start, string end)
{
    for (int i = 0; i < PeopleArray.Length; i++)
    {
        if ((start == PeopleArray[i].starting && end == PeopleArray[i].ending) || (start == PeopleArray[i].ending && end == PeopleArray[i].starting))
        {
            Console.WriteLine("The long path is : " + PeopleArray[i].long_path);
